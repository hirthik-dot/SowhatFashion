...
export default function CategoriesPage() {
  ...
  return (
    <BillingShell title="Categories Management">
      <div className="p-6 md:p-8 max-w-5xl mx-auto text-[var(--text-primary)]">
        {/* Header */}
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={() => handleAddCategory()} className="bg-[var(--gold)] text-black rounded-lg px-6 py-2.5 shadow-sm text-sm flex items-center gap-2 font-bold cursor-pointer hover:bg-[var(--gold-hover)] transition-all transform hover:scale-105">
            ...
            groupedData.map((group) => {
              ...
              return (
                <div key={group._id} className="pos-card overflow-hidden shadow-lg border border-[var(--border)] transition-all duration-300">
                  {/* Supplier Header */}
                  <div 
                    className="flex items-center justify-between px-6 py-4 bg-[var(--surface-2)] cursor-pointer hover:bg-[var(--border)] transition-colors border-b border-[var(--border)]"
                          ...
                          {group.mains.map((parent) => {
                            ...
                            return (
                              <div key={parent._id} className="group">
                                {/* Main Category Row */}
                                <div className="flex items-center justify-between px-6 py-3 pl-12 hover:bg-[var(--surface-2)] transition-colors">
                                  <div className="flex items-center gap-3">
                                ...
                                {/* Subcategories */}
                                <div className="bg-[var(--surface)] pl-20">
