...
const billing_pending_1 = __importDefault(require("./routes/billing-pending"));
...
app.use('/api/billing/pending', billingAuthMiddleware_1.billingAuthMiddleware, billing_pending_1.default);
