...
export declare const requireAnyPermission: (...permissions: Array<keyof BillingAdminPermissions>) => (req: BillingAuthRequest, res: Response, next: NextFunction) => void | Response<any, Record<string, any>>;
