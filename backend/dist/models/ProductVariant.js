...
const ProductVariantSchema = new mongoose_1.Schema({
    parentProductId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Product', required: true, index: true },
...
ProductVariantSchema.pre('validate', function (next) {
    if (!this.slug && this.colorName) {
        this.slug = (0, slugify_1.default)(this.colorName, { lower: true, strict: true });
    }
    next();
});
