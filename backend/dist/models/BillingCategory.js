...
const BillingCategorySchema = new mongoose_1.Schema({
    name: { type: String, required: true, trim: true },
    slug: { type: String, unique: true, trim: true },
    parentCategory: { type: mongoose_1.Schema.Types.ObjectId, ref: 'BillingCategory', default: null },
...
exports.default = mongoose_1.default.model('BillingCategory', BillingCategorySchema);
