...
const SLUG_META: Record<string, { title: string; initialParams?: Record<string, string> }> = {
  ...
  shirt: { title: 'Shirts', initialParams: { category: 'shirt' } },
  trousers: { title: 'Pants', initialParams: { category: 'pant' } },
  pants: { title: 'Pants', initialParams: { category: 'pant' } },
  pant: { title: 'Pants', initialParams: { category: 'pant' } },
  tshirts: { title: 'T-Shirts', initialParams: { category: 'tshirt' } },
  tshirt: { title: 'T-Shirts', initialParams: { category: 'tshirt' } },
  track: { title: 'Track', initialParams: { category: 'track' } },
  tracks: { title: 'Track', initialParams: { category: 'track' } },
  shorts: { title: 'Shorts', initialParams: { category: 'shorts' } },
  innerwears: { title: 'Innerwears', initialParams: { category: 'innerwears' } },
  innerwear: { title: 'Innerwears', initialParams: { category: 'innerwears' } },
  footwears: { title: 'Footwears', initialParams: { category: 'footwears' } },
  footwear: { title: 'Footwears', initialParams: { category: 'footwears' } },
