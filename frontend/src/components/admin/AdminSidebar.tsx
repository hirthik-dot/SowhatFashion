...
export default function AdminSidebar() {
  ...
  return (
    <aside className="admin-sidebar fixed left-0 top-0 bottom-0 z-40 hidden md:block border-r border-[#333]">
      <div className="p-6">
        <Link href="/">
          <h1 className="text-xl font-bold tracking-[0.1em] font-playfair text-white">
            SO<span className="text-[var(--gold)]">WAAT</span> <span className="text-sm font-sans tracking-normal opacity-70">ADMIN</span>
          </h1>
        </Link>
      </div>
